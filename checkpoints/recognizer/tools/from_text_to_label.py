...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_train_file_path', type=str,default='/path/to/menu_data/tmp_data/recognizer_txts/train.txt')
    parser.add_argument('--dst_train_file_path', type=str,default='/path/to/menu_data/tmp_data/recognizer_txts/real_train.txt')
