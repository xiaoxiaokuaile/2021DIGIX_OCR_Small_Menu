...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_save_dir',
        default='/path/to/menu_data/checkpoints/recognizer')
    parser.add_argument('--log_dir',
        default='/path/to/menu_data/output/recognizer_log')
    # 加载特殊字符训练集
    parser.add_argument('--image_dir',
        default='/path/to/menu_data/tmp_data_special/recognizer_images')
    parser.add_argument('--txt_dir',
        default='/path/to/menu_data/tmp_data_special/recognizer_txts')
    # 加载预训练模型pre train model path
    parser.add_argument('--pre_train_model_path', type=str,
        default=r'recognizer/CNN_CTC_base_modle.h5')
    ...
    epochs = 50
    base_model, model = crnn_model_based_on_densenet_crnn_time_softmax_activate(initial_learning_rate=0.0003,mode='train_again')
